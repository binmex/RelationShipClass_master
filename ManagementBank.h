...
private:
    std::vector<Account*> accounts;//almacena referencias de cuentas (cardinalidad de uno a muchos)
    std::vector<Customer*> customers;//almacena referencias de customer(clientes) (cardinalidad de uno a muchos)
};
